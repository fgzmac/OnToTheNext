...
export function RecommendationPhoto({ photo, name }: { photo?: ExperiencePhoto | null; name: string }) {
  ...
  return <figure className="idea-photo">
    <Image unoptimized={photo.asset.startsWith("https://")} src={photo.asset} alt={photo.alt} width={photo.width} height={photo.height} sizes="(max-width: 760px) 100vw, 560px" onError={() => setFailed(true)} />
