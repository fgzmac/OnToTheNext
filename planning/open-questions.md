...
**Next discussion:** Q-012 — should discovery recommend ready-made excursions, assemble combinations of separate activities, or both? Q-006's initial appealing/rejectable examples are now recorded in D-019; observed workarounds and broader evidence remain open.
...
**Already answered:** Japan pilot first; eventual app-store/SaaS subscription/ad ambition. Couple, two travelers. Both hotel and transport existing-booking organization and recommendations in the first version. Tokyo and private timing supplied; November 10, 2026 first test approved. Travel range per person, plane tickets excluded. Reservation-dependent events/restaurants included. Free-first app spending with flexible $100/$150 references, not a fixed ceiling or purchasing authority. **Ranked standards: useful high-quality suggestions first, same-day nearby discovery/on-the-fly planning second, seamless functionality third.** The same-day capability is required in the first version. Initial organizer examples favor scenic, participatory, locally distinctive and multi-part experiences over standalone novelty-object/statue stops; these are personal taste, not global rules. See D-006 through D-019.

| ID | Question | Why it matters | Status |
| --- | --- | --- | --- |
| Q-012 | Should the app recommend ready-made excursions, put together combinations of separate activities, or offer both? | Distinguishes an actual operator's product from an app-proposed plan, with different source, timing, cost, inclusion, and booking needs. | NEXT — D-019 supplies preference examples, not a format decision. D-010's earlier 'both' concerned hotel/transport support and is not approval of this question. |
| Q-006 | What current planning frustrations, workarounds, or observed behavior provide evidence? How do further examples refine personal quality? | Connects stated preferences to the actual problem without treating one person's taste as a market-wide rule. | PARTIALLY RESOLVED — appealing/rejectable examples supplied in D-019. Do not ask for the same examples again; observed behavior and workarounds remain OPEN. |
...
Q-012 now distinguishes a ready-made provider excursion from a proposed sequence of separately sourced stops. Do not claim the latter is one package, price, or reservation. Actual operator inclusions and the timing, travel, costs, and booking needs of separate components require later verification. No package format, automatic bundling, provider, paid service, or booking transaction is approved merely by the positive examples.
...
**Cost note:** Prior examples remain references, not an upgrade schedule, provider choice, quote, or capacity promise. Re-verify when relevant. Development tools, one-time costs, and data contracts stay separate. This preference update does not refresh price research.
...
| Q-204 | What information makes cards easy to judge? How show reasons, events versus venues, what travelers do/see, times, costs, booking needs, sources, and uncertainty? | OPEN — D-019 supplies personal preference examples, not ranking weights or UI rules. If Q-012 includes both formats, distinguish provider excursions from app-created combinations. |
...
| Q-210 | Reservation requirement, booking windows, booking/payment states, tentative plans, and unavailable/unknown slots? | OPEN detail — D-015 plus D-018 same-day feasibility; no automatic action approved. Proposed multi-part plans do not create combined availability or reservations. |
| Q-211 | Budget bounds, currency/basis, exclusions, totals, shared costs, deposits, uncertain prices, and over-budget choices? | OPEN detail — preserve D-014/D-016; D-017 is app policy, not travel accounting. Package inclusions versus separate component costs need clarity if that format is selected. |

## Section 4 — Scope and Success

| ID | Question | Status |
| --- | --- | --- |
| Q-301 | Additional destinations, languages, devices, local-day coverage, wider trip/group limits? | PARTIALLY ANSWERED — Tokyo/Japan, two people, 2026 context; remaining scope OPEN. D-019's examples do not select actual destinations, tour modes, or seasonal availability. |
| Q-302 | Minimum modes/coverage for both hotel/transport paths, reservation awareness, and same-day discovery? How allocate remaining work among prototype/pilot/commercial phases? | PARTIALLY ANSWERED — confirmed capabilities cannot silently become future-only. Excursion-format capability follows Q-012, not inferred from D-019. |
...
| Q-304 | What observable, measurable results establish recommendation quality, same-day usefulness, seamless tasks, and owner acceptance? | OPEN — order confirmed D-018; D-019 gives initial personal examples, not a complete benchmark. Define samples, denominators, thresholds, and checks before claiming success. |
| Q-305 | What scheduling constraints protect hotels, transport, local-time meaning, partial days, buffers, and fixed reservations when forming or changing a day? | OPEN — detailed rules and guarantees unapproved. Connected experiences must be evaluated for the full sequence's practical fit, not just appeal of components. |
...
| Q-309 | What minimum nearby event/experience coverage, freshness, response speed, location reach, no-result behavior, and plan creation must the pilot demonstrate? | OPEN detail — basic capability required D-018. Do not guarantee every festival/pop-up, real-time inventory, or a fixed number of results without evidence. |
...
| Q-352 | What independently checked recommendation and itinerary examples test hotel/transport, reservations, budgets, partial days, and current events? | OPEN — D-019's examples are stated preferences, not verified offerings or a full test set. Compare appeal and feasibility, including useful single activities and multi-part combinations. |
...
| Q-402 | Where do places, dated event occurrences, accommodation, prices, transport, reservation information, and booking status come from? How reconcile conflicts and distinguish retrieved, verified, estimated, and user-entered facts? | OPEN — no provider or freshness authority selected. Actual excursion listings and claimed inclusions would need verification if Q-012 selects them. |
...
| Q-404 | Concepts/states for venues versus event occurrences, saved/scheduled items, stays, legs, local time, reservations/payments, budgets, and published versions? | OPEN — candidate distinctions, not schema approval. If both excursion formats are selected, preserve the distinction between an operator offering and an app-assembled sequence. |
...
| Q-502 | Acceptance, permissions, contracts, data changes, failures? | OPEN — translate D-018 and relevant D-019 preference examples into agreed checks; do not invent thresholds or universal category bans. |
...
| Q-506 | Has design completion/implementation transition been approved? | OPEN — target, policy, priorities, and preference examples do not approve transition. |
...
| Q-006 (initial examples) | What would the organizer consider adding or reject? | Positive: beach-view/snorkeling/oceanside-dinner excursion; scenic ATV exploration with a distinctive local element. Negative: standalone novelty-object and historical-statue examples. Personal preferences, not worldwide category rules or verified trip options. | D-019 — recorded 2026-09-19; workarounds/evidence still open. |

## Resolution procedure

Update active sections and decision records together. Preserve history and record explicit deferrals with reasons/owners/triggers. No section approval without the owner's approval. Do not equate a priority or preference answer with successful testing.

**Current next step:** Ask Q-012 about ready-made excursions, app-created combinations, or both. Do not re-ask the examples or reuse the earlier hotel/transport 'both' answer for this new distinction. Keep discussion at product level; no actual excursion search or provider choice is needed for recording the preference. Preserve free-first policy and confirmed capabilities. Remaining currency, category, capacity, separate-cost, current-workaround, and full-promise questions stay open. Private trip details stay in chat.
