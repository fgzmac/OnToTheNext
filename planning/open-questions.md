...
Proceed one useful decision at a time. Offer a recommended starting point instead of demanding that the traveler solve the route or budget from scratch.
...
| --- | --- | --- | --- |
| Q-013 | Which phone operating systems, browsers, accessibility needs, and device capabilities should tests cover? | Specifies coverage without choosing native/web or framework. | Phone focus resolved D-026; detailed matrix open. |
| Q-008 | Local discovery sessions, tasks, feedback, Japan rehearsals, and outside recruitment? | Separates participation, evidence, and editing rights. | D-025 local testing; D-026 spontaneous-discovery focus and no beta dependency for actual planning. Sessions/roles open. |
| Q-005 | Does the complete product promise reflect standards, balanced days, and recommendation-led planning? Further deal-breakers? | Supports review without treating individual choices as full approval. | PARTIAL; full promise/product acceptance open. Do not block urgent trip preparation. |
| Q-004 | Actual effort/progress, maintenance, separate tools/setup, and necessary expenses? | Separates estimates from commitment and payment authority. | As-needed effort D-024 and free-first D-017 answered; actual purchases/estimates open. |
| Q-006 | Current tools and measurable workflow baseline? | Distinguishes self-report from observed improvement. | Tastes D-019, sources D-021, problems D-023 answered; remaining research is not a reason to repeat broad questions. |
...
**D-028 sequence/baseline:** Main-city itinerary and booking needs first, extensions afterward. Only flights booked, user-reported. Interest in candidates is not selection. Completion/substep order open. No requirement to purchase everything before optional discovery or automatic changes/cancellations. Extension capability remains included.

**D-027 destinations:** Tokyo/Kyoto/Osaka starting cities; other cities recommended for worthwhile experiences, not obscurity alone. Proposed support explains appeal, dates, day trip/overnight, added travel/lodging/cost, displaced time, reservations, evidence. No quota, hotel limit, algorithm, or automatic rewrite. Research is not an app feature or booking.

**D-026 workstreams:** Japan manual research/planning now; phone-first spontaneous discovery tested in San Jose. No OS/native/web/provider/simulator/host/store/transaction/notification/location-access choice. Desktop parity is not priority.

**D-025 history:** Local→beta→Japan simulations is not a prerequisite for actual trip preparation. Rehearsals may follow beta. Local success is not Japan coverage; controlled/historical scenarios and current verified information differ. Local testing is not localhost-only; San Jose is a test-area label, not residence/tracking permission.

**D-024 flow/effort:** One/two main experiences → free time/hotel rest → user opens app → optional radius discovery. Not a mandatory quota, hotel return, extra outing, break, radius, GPS permission, fatigue detection, or automatic changes. Staying in is valid. Distance and usable travel/entry differ. As-needed effort is not unlimited capacity.

**D-023 problems:** Choice/order, coherent organization, energy versus shopping/food/free time, dated events, starting amid hotel/travel/quality variables. Proposed manageable steps, known-hotel context, explicit unknowns, preserved free time. No distance-only objective, required booking before discovery, health inference, energy score, or fixed ratio. D-030 now confirms guided idea refinement, not a particular automatic-draft mechanism.

**D-018 standards:** Quality, same-day usefulness, seamless function. Same-day remains first-version work; sharing retained. Correctness/privacy/reliability/accessibility not waived. Coverage/freshness/latency/counts/weights/tests open.

**D-019 taste:** Scenic participatory/local combinations appeal more than the supplied standalone novelty/statue examples. Not a universal history ban, companion agreement, physical/risk/luxury assumption, or verified trip option.

**D-020 formats:** Operator excursions and app combinations. Separate components do not imply one package/price/reservation. Shorter/all-day categories tentative. Check total time/included transfers; do not invent shorter fixed tours.

**D-021 sources:** Firsthand/Reddit/reviews/calendars/highlights. No mandatory popularity, thresholds, APIs/scraping/history access/licenses/copying/training rights or marketing channel. Preserve critical caveats, duplicates/conflicts, actual occurrences. Appeal evidence is not current logistics.
...
| Q-106 | How collect/combine individual/group tastes, hotel strategies, exclusions, budgets, and pace? | OPEN; do not apply organizer preferences or reactions universally. |
...
| Q-352 | Local discovery/Japan scenarios for appeal, guided planning, hotel strategies/exclusions/value, extensions, balanced days, stays/travel/budgets/events/formats/sources? | OPEN; test uncertain info, unfamiliar options, declined location, late entry, bookings, no matches, corrections, local time, and conflicting changes. No suite approved. |
| Q-353 | Blocking feasibility/paid-free constraints/fallbacks/success? | OPEN; investigate Japan data early; do not block actual trip on beta or activate costs. |
| Q-354 | Wider demand, repeat value, payments/ads/costs? | OPEN; personal trip/couple tests not market validation. |
| Q-355 | Reliable release windows/booking routes/availability? | OPEN integration evidence; verify selected main-city items without claiming automation. |
| Q-356 | Useful date-correct options and known omissions, including later expansions? | OPEN; distinguish annual patterns/current editions/inventory, duplication/conflicts, cancellation, entry, fetched versus verified. |

## Sections 6–8 — System, Dependencies, API Capabilities

| ID | Question | Status |
| --- | --- | --- |
| Q-401 | Platform/structure/storage/identity/AI/providers for needs/free-first? | OPEN; guided recommendations do not require a selected AI model or choose native/web. |
| Q-402 | Sources for experiences/reviews/calendars/local advice, actual room rates/attributes, inclusions, stays/transport/bookings/effort and reaction context? | OPEN; manual sources are not integrations, quality guarantees, or live inventory. |
| Q-403 | Access/rights/attribution/retention/coverage/freshness/quotas/expiry/billing/prices? | OPEN; recheck before selecting, copying, scraping, or spending. |
| Q-404 | Venues/events/cities, formats, planned/optional/free/completed, stays/time/bookings/payments/budgets, source evidence, preferences/exclusions/reactions/search areas? | OPEN concepts, not schema. Trip preference need not become permanent account default; review differs from booked/paid. |
| Q-405 | Phone performance/reliability/accessibility/privacy/consent/deletion/abuse/usage/recovery? | OPEN; no ongoing GPS, health data, fixed cutoff, or precision targets. |
| Q-406 | APIs for pre-trip/same-day, staged destinations, reaction-driven refinement, hotel comparison, radius search, changes? | OPEN. |
...
| R-002 | Process? | Sequential blueprint; actual-trip priority later amended. | D-001/D-026 |
...
| Q-009 | Hotels/transport? | Existing bookings and recommendations, both. | D-010 |
| Q-004 (timing) | Test target? | November 10, 2026 software target; private travel inputs supplied. | D-012/D-013 |
| R-005 | Trip range? | Private bounds excluding airfare. | D-014 |
| Q-011 (basis) | Per person? | Yes. Other meanings open. | D-016 |
...
| Q-006 (examples) | Appeal/rejection? | Scenic active/local combinations; standalone novelty/statue negative examples. | D-019 |
...
| Q-004 (effort) | Weekly commitment? | As necessary; not numerical/unlimited. | D-024 |
| R-009 | Day example? | Main experiences, rest, optional radius discovery. | D-024 |
| Q-008 (direction) | Testing? | Earlier local→beta→Japan; now San Jose spontaneous discovery, actual trip independent. | D-025/D-026 |
| Q-013 (focus) | Devices? | Phones; OS/browser/native/web open. | D-026 |
| R-010 | Japan planning waits for beta? | No; itinerary/reservation preparation now. | D-026 |
| Q-014 (cities) | Starting cities? | Tokyo, Kyoto, Osaka; order/nights open. | D-027 |
| R-011 | Lesser-known destinations? | Include when worthwhile, after core-city itinerary. | D-027/D-028 |
| Q-015 | Existing bookings? | Flights only, owner-reported; hotels/intercity/timed experiences unbooked. | D-028 |
| R-012 | Main cities or extensions first? | Core itinerary/booking needs first, branch out later. Candidates liked, not selected. Completion gate open. | D-028 |
