...
**Next question to discuss:** Q-004 — review the proposed first full test approximately two weeks before travel; make the working year assumption explicit.
...
**Already answered:** The immediate goal is developing and testing for the Japan trip; the ultimate goal is commercial app-store or SaaS launch with subscription and ad revenue. The pilot audience is a couple: two travelers total, one organizer and one companion. For both hotels and transportation, the first version must organize existing bookings and recommend options before booking. Tokyo is a confirmed destination. The owner supplied outbound and return month/day endpoints in chat; the public record keeps only the late-November to early-December window. See D-006 through D-011 and resolved Q-002/Q-003/Q-007/Q-009. Do not re-ask these choices or the supplied travel endpoints.

| ID | Question | Why it matters | Status |
| --- | --- | --- | --- |
| Q-004 | Does a first complete test approximately two weeks before travel work as the readiness target? What remaining year, budget, operating-cost, development-time, and maintenance constraints apply? | Separates an app-ready target from the supplied travel window without promising delivery or publishing private dates. | PARTIALLY ANSWERED — outbound/return month-day endpoints supplied in chat; 2026 is a working assumption; proposed test target unapproved. Next discuss only the concrete test target with its assumed year. |
...
**Timing clarification:** The stated trip has an approximately two-week calendar span crossing a month boundary. That is not an approved software deadline, a count of hotel nights, or a guarantee of full activity days. Tokyo is included, but additional destinations are not settled. Exact travel dates remain in the conversation rather than this public repository. Review the proposed testing target with the owner; do not treat the travel-date answer as approval of it.
...
| ID | Question | Status |
| --- | --- | --- |
| Q-201 | Which trip basics are required initially, and is date-free exploration supported? How are travel endpoints distinguished from local arrival/departure times? | OPEN — parked for Section 3; the pilot's month/day endpoints are already supplied privately |
...
| ID | Question | Status |
| --- | --- | --- |
| Q-301 | What additional destinations, actual local-day coverage, languages, devices, and broader trip/group limits must be supported beyond the confirmed pilot context? | PARTIALLY ANSWERED — Japan/Tokyo, two travelers, and a late-November to early-December calendar window confirmed; year assumed 2026, additional cities and remaining coverage OPEN |
...
| Q-305 | What does realistic scheduling promise, including accommodation and transportation constraints, and which unknowns or manual checks must be disclosed? | OPEN — detailed constraints and guarantees not approved; calendar endpoints alone do not establish available activity time or hotel nights |
...
| Q-352 | What real-data samples and manually checked itineraries should be used for feasibility tests, including existing-booking organization and hotel/transport recommendations? | OPEN — Tokyo and a month-spanning trip inform candidate test cases; exact samples and tests remain OPEN |
...
| Q-002 | What is the primary project objective and priority? | Develop and test for the Japan trip first; ultimately launch commercially through a mobile app store or as SaaS. Pilot and public launch are separate milestones. | D-006, D-007 — resolved 2026-09-19; travel context clarified by D-011 |
...
**Current next step:** Review the proposed first full test approximately two weeks before travel under Q-004, using the concrete proposed date in chat and labeling the year assumption. The owner supplied travel dates, not approval of this testing target. Address remaining budget/capacity constraints afterward, one at a time. Do not re-ask the supplied outbound/return month-day endpoints, Q-009, or the pilot group/count. Keep exact private travel dates and booking details out of this public repository.
